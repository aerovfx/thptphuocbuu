...
import { Brain, Play, RotateCcw, Activity, Loader2 } from "lucide-react";
...
export default function DataSimAIPage() {
  ...
  const config = {
    name: "DataSim AI",
    title: "Mô phỏng dữ liệu và AI",
    description: "Tạo dữ liệu, huấn luyện AI, phân tích kết quả",
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center space-x-3">
          ...
          <h1 className="text-3xl font-bold">Mô phỏng dữ liệu và AI</h1>
        
              </div>
        <p className="text-lg text-muted-foreground">
          Tạo dữ liệu, huấn luyện AI, phân tích kết quả
        </p>
