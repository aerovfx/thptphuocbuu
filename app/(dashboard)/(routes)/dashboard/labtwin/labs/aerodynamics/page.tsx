...
import { Wind, Play, RotateCcw, Activity, Loader2 } from "lucide-react";
...
export default function AerodynamicsPage() {
  ...
  const config = {
    name: "Aerodynamics",
    title: "Khí động lực học",
    description: "Mô phỏng dòng chảy không khí và lực khí động",
    category: "Cơ học",
    level: "Nâng cao",
    xp: 250,
    port: 8008
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center space-x-3">
          ...
          <h1 className="text-3xl font-bold">Khí động lực học</h1>
        
              </div>
        <p className="text-lg text-muted-foreground">
          Mô phỏng dòng chảy không khí và lực khí động
        </p>
