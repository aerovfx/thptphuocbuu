...
const educationQuizData = {
  ...
  questions: [
    ...
    ...Array.from({ length: 20 }, (_, i) => ({
      id: 21 + i,
      question: `Câu hỏi ${21 + i}: Đây là câu hỏi mẫu cho đề thi THPT Quốc gia môn Hóa học. Nội dung câu hỏi có thể liên quan đến các chủ đề như este, axit cacboxylic, ancol, phenol, amin, amino axit, protein, cacbohidrat, lipit, polime, đại cương về kim loại, kim loại kiềm, kim loại kiềm thổ, nhôm, sắt, crom và các hợp chất của chúng.`,
